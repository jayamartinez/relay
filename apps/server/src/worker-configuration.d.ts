/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 3075c570c15cf5a815751568421a9212)
// Runtime types generated with workerd@1.20260903.1 2026-09-03 
interface __BaseEnv_Env {
	EDGE_LIMIT: RateLimit;
	ENROLL_LIMIT: RateLimit;
	ACCOUNTS: DurableObjectNamespace<import("./index").RelayAccount>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "RelayAccount";
	}
